...
public class ClienteService {
	...
	@Autowired
	private EnderecoRepository repo_endereco_repository;
	...
	public Cliente insert(Cliente obj) {
		...
		obj.setId(null);
		obj = repo.save(obj);
		repo_endereco_repository.saveAll(obj.getEnderecos());
		return obj;
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDTO) {
		...
		Cliente cli = new Cliente(null, objDTO.getNome(), objDTO.getEmail(), objDTO.getCpfCNPJ(), TipoCliente.eNum(objDTO.getTipo()), pe.encode(objDTO.getSenha()));
